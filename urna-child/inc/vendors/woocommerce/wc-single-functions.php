...
/**Sticky Menu Bar**/
        ...
        //add_action('urna_sticky_menu_bar_product_price_cart', 'urna_sticky_menu_bar_custom_add_to_cart_button', 10);
      ...
      <div id="sticky-menu-bar">
        <div class="container">
          <div class="row">
            ...
            <div class="menu-bar-right col-md-5 col-sm-4">
                <?php
...
/*function urna_sticky_menu_bar_custom_add_to_cart_button()
{
    global $product;
    ...
    if (!$product->is_in_stock()) {
        ...
        ?> 
        <a id="sticky-custom-add-to-cart" class="single_add_to_cart_button external" href="javascript:void(0);"><?php echo esc_html($product->single_add_to_cart_text()); ?>321</a>
    <?php
    }
}*/
...
if (!function_exists('urna_mobile_before_grouped_product_list')) {
    ...
    function urna_mobile_add_btn_after_add_to_cart_form()
    {
		...
		<!--	<div id="tbay-click-addtocart">< ?php esc_html_e('Add to cart', 'urna') ?></div>-->
			<div id="tbay-click-addtocart"><?php esc_html_e('Search Offer Now', 'urna') ?></div>
