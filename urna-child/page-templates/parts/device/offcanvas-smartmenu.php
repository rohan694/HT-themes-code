<?php
    ...
    if ($menu_second) {
        ...
        $menu_tab_second        = urna_tbay_get_config('menu_mobile_tab_second', 'Categories');
            ...
            <div class="mmenu-account">
                <?php 
                    ...
                    if (!empty($menu_third_id)) {
                        ...
                        if ($menu_third_obj) {
                            $menu_third_name = urna_get_transliterate($menu_third_obj->slug);
                        }
                    }
        ...
        <?php
            ...
            if ($menu_second) {
                ...
                if (!empty($menu_second_id)) {
                    ...
                    if ($menu_second_obj) {
                        $menu_second_name = urna_get_transliterate($menu_second_obj->slug);
                    }
                }
