...
(function (factory) {
  ...
  jQuery.fn.SumoSelect = function (options) {
    ...
    const ret = this.each(function () {
      ...
      const settings = jQuery.extend({}, defaultOptions, options, $(this).data());
      ...
      this.sumo = {
        ...
        toggSelAll(c, direct) {
          const O = this;
          const cloneOriginalEvents = jQuery.extend(true, {}, jQuery._data(O.E.get(0), "events")); // clone original select elements events
          ...
          jQuery.each(cloneOriginalEvents, (_, e) => {
            jQuery.each(e, (__, ev) => {
