...
(function ($) {
  ...
  UrnaAdminModule.prototype = {
    ...
    SizedeliveryChange: function () {
      $('#_urna_size_guide_type').on('change', function () {
        if ($(this).val() === 'global') {
      ...
      $('#_urna_delivery_return_type').on('change', function () {
        if ($(this).val() === 'global') {
  ...
  jQuery.UrnaAdminModule = UrnaAdminModule.prototype;
