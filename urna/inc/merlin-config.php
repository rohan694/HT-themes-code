...
- - - - - - - - - - - - - - - - - - - - */";
    ...
    {
        $cpt_support = ['tbay_custom_post', 'tbay_megamenu', 'tbay_footer', 'tbay_header', 'post', 'page'];
    ...
    private function update_option_woof() {
        ...
        $settings['custom_tax_label']['pa_size'] = esc_html__('Product Size', 'urna');

        /**Color**/
        $settings['tax']['pa_color'] = '1';
        $settings['show_title_label']['pa_color'] = '1';
        $settings['custom_tax_label']['pa_color'] = esc_html__('Product Color', 'urna');

        /**Tag**/
        $settings['tax']['product_tag'] = '1';
        $settings['tax_type']['product_tag'] = 'label';
        $settings['show_title_label']['product_tag'] = '1';
        $settings['custom_tax_label']['product_tag'] = esc_html__('Product Tags', 'urna');
