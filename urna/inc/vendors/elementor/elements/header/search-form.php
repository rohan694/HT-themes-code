...
class Urna_Elementor_Search_Form extends Urna_Elementor_Widget_Base
{
    ...
    protected function _register_form_search()
    {
        ...
        $this->add_control(
            'search_in',
            [
                'label'   => esc_html__('Search In', 'urna'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'only_title',
                'condition' => [
                    'search_type' => 'product'
                                ...
                                <div class="input-group">
                                    <?php if ($enable_categories_search === 'yes'): ?>
                                        <div class="select-category input-group-addon">
                                            <?php if (urna_is_Woocommerce_activated() && $search_type === 'product') :
                                                $args = array(
                                    ...
                                    <?php endif; ?>
                                        <input data-style="right" type="text" placeholder="<?php echo esc_attr($placeholder_text); ?>" name="s"  class="tbay-search form-control input-sm"/>
                ...
                <form action="<?php echo esc_url(home_url('/')); ?>" method="get" <?php echo $this->get_render_attribute_string('search_form'); ?> >
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <?php endif; ?>
                                <input data-style="right" type="text" placeholder="<?php echo esc_attr($placeholder_text); ?>" name="s" required class="tbay-search form-control input-sm"/>
...
$widgets_manager->register(new Urna_Elementor_Search_Form());
