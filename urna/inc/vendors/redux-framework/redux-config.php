...
if (!class_exists('Urna_Redux_Framework_Config')) {
    class Urna_Redux_Framework_Config
    {
        ...
        public function setSections()
        {
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'default' => '<p>Copyright  &#64; 2023 Urna Designed by ThemBay. All Rights Reserved.</p>',
                ...
                'fields' => array(
                   ...
                   array(
                    ...
                    array(
                        ...
                        'type'     => 'textarea',
                        'title'    => esc_html__('HTML Before Inner Product Summary (Global)', 'urna'),
                        'desc' =>   sprintf( wp_kses( __('Enter HTML and shortcodes that will show before title product.  You can see more HTML display position on the image <a target="_blank" href="%1$s">here</a>.', 'urna' ),  array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), 'https://docs.thembay.com/puca/src/img/hook-single-product.jpg' ), 

                    ),
                    array(
                        'id'       => 'html_after_inner_product_summary',
                        'type'     => 'textarea',
                        'title'    => esc_html__('HTML After Inner Product Summary (Global)', 'urna'),
                        'desc' =>   sprintf( wp_kses( __('Enter HTML and shortcodes that will show after social product.  You can see more HTML display position on the image <a target="_blank" href="%1$s">here</a>.', 'urna' ),  array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), 'https://docs.thembay.com/puca/src/img/hook-single-product.jpg' ), 
                    ),
                    array(
                        'id'       => 'html_before_product_summary',
                        'type'     => 'textarea',
                        'title'    => esc_html__('HTML Before Product Summary (Global)', 'urna'),
                        'desc' =>   sprintf( wp_kses( __('Enter HTML and shortcodes that will show before content product.  You can see more HTML display position on the image <a target="_blank" href="%1$s">here</a>.', 'urna' ),  array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), 'https://docs.thembay.com/puca/src/img/hook-single-product.jpg' ), 
                    ),
                    array(
                        'id'       => 'html_after_product_summary',
                        'type'     => 'textarea',
                        'title'    => esc_html__('HTML After Product Summary (Global)', 'urna'),
                        'desc' =>   sprintf( wp_kses( __('Enter HTML and shortcodes that will show after related products.  You can see more HTML display position on the image <a target="_blank" href="%1$s">here</a>.', 'urna' ),  array(  'a' => array( 'href' => array(), 'target' => array() ) ) ), 'https://docs.thembay.com/puca/src/img/hook-single-product.jpg' ), 
                    ),
                )
            ...
            $this->sections[] = array(
                'subsection' => true,
                'title' => esc_html__('WooCommerce Open', 'urna'),
                'fields' => array(
                    array(
                        'id' => 'size_guide_product_type',
                        'type' => 'button_set',
                        'title' => esc_html__('Size guide shown in product type', 'urna'),
                        'options' => array(
                                'all'          => esc_html__('All Product Type', 'urna'),
                                'variable'     => esc_html__('Only Variable Product', 'urna'),
                        ),
                        'default' => 'variable'
                    ),
                    array(
                        ...
                        'type'     => 'textarea',
                        'title'    => esc_html__('Size Guide - Single Product Page (Global)', 'urna'),
                    ),
                    array(
                        'id'       => 'single_delivery_return',
                        'type'     => 'textarea',
                        'title'    => esc_html__('Delivery & Return - Single Product Page (Global)', 'urna'),
                    ),
                    array(
                        'id'       => 'single_aska_question',
                        'type'     => 'textarea',
                        'title'    => esc_html__('Ask a Question - Single Product Page (Global)', 'urna'),
                    ),
                )
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'switch',
                        'title' => esc_html__('Show Quantity Product', 'urna'),
                        'subtitle'  => esc_html__('Enable or disable "Quantity Product" on Review Order on page Checkout', 'urna'),
                        'default' => true
                    ),
                )
            );
