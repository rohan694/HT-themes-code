...
class Urna_Widget_Custom_Menu extends Urna_Widget
{
    public function __construct()
    {
        parent::__construct(
            'urna_custom_menu',
            esc_html__('Urna Custom Menu', 'urna'),
            array( 'description' => esc_html__('Show custom menu', 'urna'), )
        );
