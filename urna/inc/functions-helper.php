...
if (!function_exists('urna_tbay_get_footer_layout')) {
    function urna_tbay_get_footer_layout()
    {
        if (is_page()) {
            ...
            return urna_tbay_woo_get_footer_layout( wc_get_page_id( 'shop' ) );
        } else if( class_exists( 'WooCommerce' ) && is_cart() ) {
            return urna_tbay_woo_get_footer_layout( wc_get_page_id( 'cart' ) );
        } else if( class_exists( 'WooCommerce' ) && is_checkout() ) {
            return urna_tbay_woo_get_footer_layout( wc_get_page_id( 'checkout' ) );
        }
...
if ( !function_exists('urna_tbay_woo_get_footer_layout') ) {
    function urna_tbay_woo_get_footer_layout( $page_id ) {
        $footer = get_post_meta( $page_id, 'tbay_page_footer_type', true );

        if ( $footer == 'global' ||  $footer == '') {
            return urna_tbay_get_config('footer_type', 'footer_default');
        } else {
            return $footer;
        }
    }
...
if (!function_exists('urna_tbay_autocomplete_suggestions')) {
    function urna_tbay_autocomplete_suggestions()
    {
        ...
        if (isset($_REQUEST['post_type']) && $_REQUEST['post_type'] !== 'post' && urna_is_Woocommerce_activated() ) {
        ...
        if ( $post_type == 'product' && urna_is_Woocommerce_activated() ) {
...
if (!function_exists('urna_elementor_pro_activated')) {
    function urna_elementor_pro_activated()
    {
