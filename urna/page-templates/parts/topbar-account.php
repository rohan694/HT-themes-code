...
<?php if (!urna_catalog_mode_active()) : ?>
	...
	<div class="tbay-login">
		...
		<?php if (is_user_logged_in()) { ?>
            ...
            ?>
			<a class="account-button" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>"><i class="linear-icon-user"></i><span class="hidden-xs"><?php esc_html_e('Hi, ', 'urna'); ?><?php echo esc_html($current_user->display_name); ?>!</span></a>
