...
Version 2.4.4  - July 30, 2023
- [ADD NEW] Add a new class 'header-element-sticky' to customize the sticky on the header element
- [FIX] Fix bug showing title page on home page

Version 2.4.3  - July 18, 2023
...
- [FIX] Fix Out Of Date the file "urna\woocommerce\cart\cart.php" 
- [FIX] Fix Out Of Date the file "urna\woocommerce\cart\mini-cart.php" 
- [FIX] Fix Out Of Date the file "urna\woocommerce\single-product\product-image.php" 
- [FIX] Fix 'Login Popup' bug

Version 2.4.1  - May 14, 2023
- [REMOVE] Remove group buttons 'Size Guide and 'Delivery Return' and 'Ask a Question' on Quick View

Version 2.4  - April 07, 2023
- [Important] Required "Urna Core" version 1.4 or greater
...
- [ADD NEW] Add new options "Size guide shown in product type" in Theme Options/WooCommerce/WooCommerce Open
...
Version 2.3.16  - February 09, 2023
...
Version 2.3.15  - November 03, 2022
...
- [FIX] Fix Out Of Date the file "urna\woocommerce\cart\cart.php"
- [FIX] Fix Out Of Date the file "urna\woocommerce\global\form-login.php"
- [FIX] Fix Out Of Date the file "urna\woocommerce\myaccount\form-login.php"

Version 2.3.14  - September 15, 2022
- Compatible with WooCommerce 6.9.x
- [ADD NEW] Add new 'locate_template' on folder 'urna/elementor_templates'  (Can override file on folder 'elementor_templates' in child theme)

Version 2.3.13  - July 25, 2022
- Compatible with WordPress 6.0
- Compatible with WooCommerce 6.7.x
- Compatible with Elementor 3.6.x
- Compatible with WPBakery Page Builder 6.9

Version 2.3.12  - May 06, 2022
...
Version 2.3.11  - February 28, 2022
- Compatible with Wordpres 5.9
- Compatible with WooCommerce 6.2.x
- [FIX] Fix bug style dokan

Version 2.3.10  - January 17, 2022
- [FIX] Fix "Sort by" on page shop not working

Version 2.3.9  - January 14, 2022
...
Version 2.3.8  - September 11, 2021
...
- [FIX] Fix Mailchimp form not translate on WPML

Version 2.3.7  - August 23, 2021
