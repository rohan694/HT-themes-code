    	...
    	<div id="tbay-quick-view-content" class="woocommerce single-product details-product">
            ...
            <div class="summary entry-summary">
                ...
                <?php
                    ...
                    remove_action( 'woocommerce_single_product_summary', 'urna_product_popup_group_buttons', 35 );
                    remove_action( 'woocommerce_single_product_summary', 'urna_action_woocommerce_before_inner_product_summary', 1 ); 
