...
add_action('urna_woo_before_shop_loop_item_caption', 'woocommerce_template_loop_rating', 5);

remove_action('urna_tbay_after_shop_loop_item_title', 'urna_tbay_woocommerce_variable', 15);
add_action('woocommerce_after_shop_loop_item_title', 'urna_tbay_woocommerce_variable', 15);
