...
remove_action('urna_woo_before_shop_loop_item_caption', 'urna_brands_the_name', 10);
add_action('urna_tbay_after_image_item', 'urna_brands_the_name', 15);
	...
	<div class="product-content">
		<div class="block-inner">
			...
			<div class="group-hover">
		    	...
		    	<?php
                    do_action('urna_tbay_after_image_item');
                ?>
		    </div>
		</div>
		<div class="caption">
