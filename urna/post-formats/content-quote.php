            ...
            if (is_single()) : ?>
				...
				<?php
                    if (has_excerpt()) {
                        ...
                        echo '<blockquote>'; ?>
							<div class="entry-description"><?php echo urna_tbay_substring(get_the_content(), 35, '...'); ?> <a href="<?php the_permalink(); ?>" title="<?php esc_attr_e('Continue reading', 'urna'); ?>"><?php esc_html_e('Continue reading', 'urna'); ?><i class="icon-arrow-right-circle icons"></i></a></div>
						<?php
                        echo '</blockquote>';
                    }
                ?>
