...
<div class="wishlist-select-dropdown-button" onclick="toggleOptions(<?php echo $wishlist['id'] ?>,  <?php echo $item->get_product_id() ?>)">
  ...
  <ul class="wishlist-select-dropdown-list underneath wishlist-dropdown-options-list-mobile<?php echo $wishlist['id'] . '#' . $item->get_product_id(); ?>"  id="wishlist-dropdown-options-list-mobile<?php echo $wishlist['id'] . '#' . $item->get_product_id(); ?>"  product_id="<?php echo $item->get_product_id(); ?>" wishlist_id="<?php echo $wishlist['id'] ?>">
    ...
    <li class="dropdown-option" onclick="selectOption('Decor', <?php echo $wishlist['id'] ?>,  <?php echo $item->get_product_id() ?>, '<?php echo $wishlist_category_images['Decor']; ?>')" <?php if (!empty($wishlistold) && $wishlistold[0]->wishlist_name == 'Decor') {
    echo 'class="selected"';
}
?>>
	...
	Decor</li>
    <li class="dropdown-option" onclick="selectOption('Wohnzimmer', <?php echo $wishlist['id'] ?> , <?php echo $item->get_product_id() ?> , '<?php echo $wishlist_category_images['Wohnzimmer']; ?>')" <?php if (!empty($wishlistold) && $wishlistold[0]->wishlist_name == 'Wohnzimmer') {
    echo 'class="selected"';
}
?>>
	...
	Wohnzimmer</li>
    <li class="dropdown-option" onclick="selectOption('Badezimmer', <?php echo $wishlist['id'] ?> , <?php echo $item->get_product_id() ?> , '<?php echo $wishlist_category_images['Badezimmer']; ?>')" <?php if (!empty($wishlistold) && $wishlistold[0]->wishlist_name == 'Badezimmer') {
    echo 'class="selected"';
}
?>>
	...
	Badezimmer</li>
    <li class="dropdown-option" onclick="selectOption('Kinderzimmer', <?php echo $wishlist['id'] ?> , <?php echo $item->get_product_id() ?>, '<?php echo $wishlist_category_images['Kinderzimmer']; ?>' )" <?php if (!empty($wishlistold) && $wishlistold[0]->wishlist_name == 'Kinderzimmer') {
    echo 'class="selected"';
}
?>>
	...
	Kinderzimmer</li>
    <li class="dropdown-option" onclick="selectOption('Schlafzimmer', <?php echo $wishlist['id'] ?> , <?php echo $item->get_product_id() ?> , '<?php echo $wishlist_category_images['Schlafzimmer']; ?>')" <?php if (!empty($wishlistold) && $wishlistold[0]->wishlist_name == 'Schlafzimmer') {
    echo 'class="selected"';
}
?>>
	...
	Schlafzimmer</li>
    <li class="dropdown-option" onclick="selectOption('Draußen', <?php echo $wishlist['id'] ?> , <?php echo $item->get_product_id() ?>, '<?php echo $wishlist_category_images['Draußen']; ?>' )" <?php if (!empty($wishlistold) && $wishlistold[0]->wishlist_name == 'Draußen') {
    echo 'class="selected"';
}
?>>
	...
	Draußen</li>
    <li class="dropdown-option" onclick="selectOption('Küche', <?php echo $wishlist['id'] ?> , <?php echo $item->get_product_id() ?> , '<?php echo $wishlist_category_images['Küche']; ?>')" <?php if (!empty($wishlistold) && $wishlistold[0]->wishlist_name == 'Küche') {
    echo 'class="selected"';
}
?>>
